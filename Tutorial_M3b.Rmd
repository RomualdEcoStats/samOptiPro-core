...
bot <- identify_bottlenecks_family(samples_ml, runtime_s,
                                        ess_threshold = 1000,
                                        sampler_params = NULL,
                                        model = m,
                                        mcmc_conf = NULL,
...
plots_cv <- plot_convergence_checks(
  samples_ml,
  out_dir ="outputs/diagnostics",   #file.path(outdir, "convergence"),
  top_k_rhat = 8,
  top_k_aelow = 8,
  runtime_s = 120,     # pretend 2 minutes total runtime
  rhat_ref = 1.01,
  make_rhat_hist   = TRUE,
