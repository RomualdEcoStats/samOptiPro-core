...
```{r diagnose-structure, message=TRUE, warning=FALSE,fig.show='hide'}
...
```{r baseline parallel-run-WGNAS , eval=TRUE, echo=TRUE, message=TRUE, warning=FALSE}
n.iter   <- 300000
n.burnin <- 25000
n.thin   <- 250
n.chains <- 10
...
```{r Run HMC/NUTS parallel, eval=TRUE,message=TRUE, warning=FALSE}
