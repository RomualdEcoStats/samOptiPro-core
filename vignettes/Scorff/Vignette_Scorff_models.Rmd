...
```{r Definition of auxiliary nimbleFunctions and compiled model object, message=FALSE, warning=FALSE}
## ------------------------------------------------------------------
...
```{r diagnose-structure, message=FALSE, warning=FALSE,fig.show='hide'}
...
```{r diagnostics-plots, echo=FALSE, message=FALSE, warning=FALSE, results='markup',fig.show='as.is', fig.width=6.5, fig.height=4.5}
...
```{r diagnostics-plots2, echo=FALSE, message=FALSE, warning=FALSE, fig.align="center"}
