...
```{r dataLoadingFormatting,eval= FALSE, echo=FALSE, warning=FALSE, message=FALSE}
...
```{r buildingZone, echo=FALSE,eval= FALSE, warning=FALSE, message=FALSE}
######building zones
if ((!file.exists(paste("datagerem_nimble2_",CY,".rdata",sep=""))) ){
  sf::sf_use_s2(FALSE)
...
```{r mapsZones, echo=FALSE,eval= FALSE,warning=FALSE,message=FALSE, fig.height=16/2.54, fig.cap="Zone definition and available data"}
sf::sf_use_s2(FALSE)
...
```{r availableData, echo=FALSE,eval= FALSE,tab.cap="Available time series of recruitment"}
...
## Running the model
```{r runningConfig, eval= FALSE,echo=FALSE, include=FALSE}
if ((!file.exists(paste("datagerem_nimble2_",CY,".rdata",sep=""))) ){
...
```{r diagnose-structure, eval= FALSE,message=TRUE, warning=FALSE}
...
```{r structure-hmc-test, eval= FALSE,message=TRUE, warning=FALSE}
...
```{r baseline parallel-run-GEREM , eval=FALSE, echo=TRUE, message=TRUE, warning=FALSE,results='markup',fig.show='as.is', fig.width=6.5, fig.height=4.5}
...
```{r strategy1-parallel-run, eval=FALSE, echo=TRUE, message=FALSE, warning=FALSE,results='markup',fig.show='as.is', fig.width=6.5, fig.height=4.5}
## ------------------------------------------------------------
...
```{r Strategy2 parallel-run-GEREM , eval=FALSE, echo=TRUE, message=TRUE, warning=FALSE,results='markup',fig.show='as.is', fig.width=6.5, fig.height=4.5}
